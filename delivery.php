...
$user_query = $conn->query("SELECT Fname, Mname, Lname, contact, email FROM customer_tbl WHERE customer_id = $user_id");
...
<body>
                        ...
                        <form id="deliveryForm">
                            ...
                            <div class="mt-4 p-4 bg-light rounded-4 border">
                                ...
                                <div class="accordion accordion-flush" id="extraMenuAccordion">
                                    <?php $acc_index = 0;
                                    foreach ($categorized_menu as $category => $items): $acc_index++; ?>
    ...
    <script>
        ...
        async function clearDeliveryCart() {
        ...
        document.getElementById('deliveryForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (data.success) {
                    await clearDeliveryCart(); // ✅ clears both localStorage and session
